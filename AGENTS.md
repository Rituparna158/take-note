...
6. Lint Verification
7. Test Verification
8. Fresh Compliance Review (`/review`)
9. OpenSpec Archive
10. Pull Request Preparation (`/pr`)

Implementation MUST NOT begin until the specification proposal, technical plan, and task checklist have all been reviewed and approved.
...
Every implementation phase SHALL complete the following quality gates in this exact order:
...
No implementation SHALL begin before an approved proposal exists. Every completed change SHALL be archived before a pull request is prepared.
